...
namespace apibookhub.Models
{
    public partial class Dbookhub : DbContext
    {
        ...
        public Dbookhub(DbContextOptions<Dbookhub> options): base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-NH96RKR;Initial Catalog=BookHub;Integrated Security=True;Persist Security Info=False;Pooling=False;MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=False");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Coment>(entity =>
            {
                entity.HasKey(e => e.ComentsId)
                    .HasName("PK__coments__47147597142AE396");
